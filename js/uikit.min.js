...
! function(t, e) {
    ...
    function V(t) {
        return N(t) ? [t] : M(t) ? l.slice.call(t) : $(t) ? t.map(W).filter(Boolean) : C(t) ? t.toArray() : []
    }
    ...
    function q(t, i) {
        return t === i || S(t) && S(i) && Object.keys(t).length === Object.keys(i).length && K(t, function(t, e) {
            return t === i[e]
        })
    }
    ...
    var it = {
        ...
        contain: function(i, n) {
            var r = this;
            return K(i = X({}, i), function(t, e) {
                return i = i[e] > n[e] ? r.ratio(i, e, n[e]) : i
            }), i
        },
        cover: function(i, n) {
            var r = this;
            return K(i = this.contain(i, n), function(t, e) {
                return i = i[e] < n[e] ? r.ratio(i, e, n[e]) : i
            }), i
        }
    };
    ...
    function nt(t, e, i) {
        if (S(e))
            for (var n in e) nt(t, n, e[n]);
        else {
            if (H(i)) return (t = W(t)) && t.getAttribute(e);
            V(t).forEach(function(t) {
                I(i) && (i = i.call(t, nt(t, e))), null === i ? ot(t, e) : t.setAttribute(e, i)
            })
        }
    }
    ...
    function dt(t, s, e) {
        ...
        mt(t = t.replace(pt, "$1 *")) && (a = [], t = function(t) {
            ...
            if ("!" === t[0]) {
                ...
                i = xt(s.parentNode, n[0]), t = n.slice(1).join(" ").trim()
            }
            if ("-" === t[0]) {
                var r = t.substr(1).trim().split(" "),
                    o = (i || s).previousElementSibling;
                i = bt(o, t.substr(1)) ? o : null, t = r.slice(1).join(" ")
            }
    ...
    function kt(t, e) {
        for (var i = [], n = W(t).parentNode; n && 1 === n.nodeType;) bt(n, e) && i.push(n), n = n.parentNode;
        return i
    }
    ...
    function Mt() {
        ...
        var i = Pt(t),
            ...
            s = i[3],
            a = i[4];
        return n = Ft(n), o && (s = function(t, n, r) {
                var o = this;
                return function(i) {
                    t.forEach(function(t) {
                        var e = ">" === n[0] ? lt(n, t).reverse().filter(function(t) {
                            return _t(i.target, t)
                        })[0] : xt(i.target, n);
                        e && (i.delegate = t, i.current = e, r.call(o, i))
                    })
                }
            }(n, o, s)), 1 < s.length && (s = function(e) {
                return function(t) {
    ...
    function Ot(t, e, i, n) {
        void 0 === n && (n = !1), t = Ft(t), e.split(" ").forEach(function(e) {
            return t.forEach(function(t) {
    ...
    var Vt = "Promise" in window ? window.Promise : Ut,
        Yt = function() {
            var i = this;
            this.promise = new Vt(function(t, e) {
    ...
    Ut.reject = function(i) {
        return new Ut(function(t, e) {
            e(i)
        })
    }, Ut.resolve = function(i) {
        return new Ut(function(t, e) {
            t(i)
        })
    }, Ut.all = function(s) {
        return new Ut(function(i, t) {
            var n = [],
                r = 0;
        ...
        return new Ut(function(t, e) {
            for (var i = 0; i < n.length; i += 1) Ut.resolve(n[i]).then(t, e)
        })
    };
    var Xt = Ut.prototype;
    ...
    function Kt(s, a) {
        return new Vt(function(t, e) {
            ...
            Mt(n, "load", function() {
                0 === n.status || 200 <= n.status && n.status < 300 || 304 === n.status ? t(n) : e(X(Error(n.statusText), {
                    xhr: n,
                    status: n.status
                }))
            }), Mt(n, "error", function() {
    ...
    Xt.resolve = function(t) {
        ...
        if (e.state === Rt) {
            ...
            try {
                var n = t && t.then;
                if (null !== t && S(t) && I(n)) return void n.call(t, function(t) {
                    i || e.resolve(t), i = !0
                }, function(t) {
                    i || e.reject(t), i = !0
                })
            ...
            if (o.state !== Rt)
                for (; o.deferred.length;) {
                    var t = o.deferred.shift(),
                        ...
                        r = t[3];
                    try {
                        0 === o.state ? I(e) ? n(e.call(void 0, o.value)) : n(o.value) : 1 === o.state && (I(i) ? n(i.call(void 0, o.value)) : r(o.value))
                    } catch (t) {
                        r(t)
                    }
                }
        })
    }, Xt.then = function(i, n) {
        var r = this;
        return new Ut(function(t, e) {
    ...
    var Jt = /msie|trident/i.test(window.navigator.userAgent),
        Zt = "rtl" === nt(document.documentElement, "dir"),
    ...
    function ue(t, e, i, n) {
        ...
        var r = (e = V(e)).length;
        return t = z(t) ? F(t) : "next" === t ? i + 1 : "previous" === t ? i - 1 : ce(e, t), n ? Z(t, 0, r - 1) : (t %= r) < 0 ? t + r : t
    }
    ...
    function $e(t) {
        ...
        return xe.test(t) ? i.insertAdjacentHTML("beforeend", t.trim()) : i.textContent = t, 1 < i.childNodes.length ? V(i.childNodes) : i.firstChild
    }
    ...
    function Oe(t) {
        ...
        if (n.length) {
            var r = D((n = Be(n))[n.length - 1]) ? [] : n.pop();
            n = n.filter(Boolean), V(t).forEach(function(t) {
                for (var e = t.classList, i = 0; i < n.length; i++) ze.Force ? e.toggle.apply(e, [n[i]].concat(r)) : e[(H(r) ? !e.contains(n[i]) : r) ? "add" : "remove"](n[i])
            })
        }
    }

    function De(t, i, n) {
        (i = Be(i).filter(Boolean)).length && V(t).forEach(function(t) {
            var e = t.classList;
            ze.Multiple ? e[n].apply(e, i) : i.forEach(function(t) {
                return e[n](t)
            })
        })
    }
    ...
    function He(t, e, r) {
        return V(t).map(function(i) {
            if (D(e)) {
                if (e = Ye(e), H(r)) return Fe(i, e);
                r || B(r) ? i.style[e] = z(r) && !Pe[e] ? r + "px" : r : i.style.removeProperty(e)
            } else {
                if ($(e)) {
                    var n = Le(i);
    ...
    function We(t) {
        ...
        if (!(t in je)) {
            var i = fe(e, document.createElement("div"));
            Ae(i, "uk-" + t), je[t] = Fe(i, "content", ":before").replace(/^["'](.*)["']$/, "$1"), ve(i)
        }
        return je[t]
    }
    var Ve = {};
    ...
    function qe(t, s, a, h) {
        return void 0 === a && (a = 400), void 0 === h && (h = "linear"), Vt.all(V(t).map(function(o) {
            return new Vt(function(i, n) {
                for (var t in s) {
                    var e = He(o, t);
                    "" === e && He(o, t, e)
                }
    ...
    var Ue = {
            start: qe,
            stop: function(t) {
                return Bt(t, "transitionend"), Vt.resolve()
            },
            cancel: function(t) {
    ...
    function Ge(t, e, i, a, h) {
        var c = arguments;
        return void 0 === i && (i = 200), Vt.all(V(t).map(function(s) {
            return new Vt(function(n, r) {
                if (Me(s, Ke)) requestAnimationFrame(function() {
                    return Vt.resolve().then(function() {
                        return Ge.apply(void 0, c).then(n, r)
                    })
                });
                else {
                    ...
                    w(e, Xe) && (a && (t += " uk-transform-origin-" + a), h && (t += " " + Xe + "reverse")), o(), Dt(s, "animationend animationcancel", function(t) {
                        var e = t.type,
                            i = !1;
                        "animationcancel" === e ? (r(), o()) : (n(), Vt.resolve().then(function() {
                            i = !0, o()
                        })), requestAnimationFrame(function() {
                            i || (Ae(s, Ke), requestAnimationFrame(function() {
                                return Ce(s, Ke)
                            }))
                        })
                    }, !1, function(t) {
                        var e = t.target;
                        return s === e
                    }), He(s, "animationDuration", i + "ms"), Ae(s, t)
                }
    ...
    function ti(t, e, u, l, d, i, n, r) {
        ...
        var p = ii(t),
            m = ii(e),
            g = m;
        if (hi(g, u, p, -1), hi(g, l, m, 1), d = ui(d, p.width, p.height), i = ui(i, m.width, m.height), d.x += i.x, d.y += i.y, g.left += d.x, g.top += d.y, n) {
            var o = [ii(wi(t))];
            r && o.unshift(ii(r)), K(Qe, function(t, s) {
                var a = t[0],
                    h = t[1],
                    c = t[2];
                (!0 === n || y(n, a)) && o.some(function(n) {
                    var t = u[a] === h ? -p[s] : u[a] === c ? p[s] : 0,
                        e = l[a] === h ? m[s] : l[a] === c ? -m[s] : 0;
                    if (g[h] < n[h] || g[h] + p[s] > n[c]) {
                        var i = p[s] / 2,
                            r = "center" === l[a] ? -m[s] / 2 : 0;
                        return "center" === u[a] && (o(i, r) || o(-i, -r)) || o(t, e)
                    }

                    function o(e, t) {
                        var i = g[h] + e + t - 2 * d[a];
                        if (i >= n[h] && i + p[s] <= n[c]) return g[h] = i, ["element", "target"].forEach(function(t) {
    ...
    function ei(i, n) {
        if (i = W(i), !n) return ii(i);
        var r = ei(i),
            o = He(i, "position");
        ["left", "top"].forEach(function(t) {
            if (t in n) {
                var e = He(i, t);
                He(i, t, n[t] - r[t] + j("absolute" === o && "auto" === e ? ni(i)[t] : e))
            }
        })
    }
    ...
    function ii(t) {
        ...
        Et(t) || "none" !== He(t, "display") || (e = nt(t, "style"), i = nt(t, "hidden"), nt(t, {
    ...
    function ni(n) {
        var r = (n = W(n)).offsetParent || function(t) {
                return bi(t).documentElement
            }(n),
            o = ei(r),
            t = ["top", "left"].reduce(function(t, e) {
                var i = g(e);
                return t[e] -= o[e] + j(He(n, "margin" + i)) + j(He(r, "border" + i + "Width")), t
            }, ei(n));
        return {
            top: t.top,
            left: t.left
    ...
    function si(n) {
        ...
        return function(t, e) {
            if (t = W(t), H(e)) {
                ...
                return (e = "auto" === (e = He(t, n)) ? t["offset" + r] : j(e) || 0) - ai(n, t)
            }
            He(t, n, e || 0 === e ? +e + ai(n, t) + "px" : "")
        }
    }

    function ai(t, i, e) {
        return void 0 === e && (e = "border-box"), He(i, "boxSizing") === e ? Qe[t].slice(1).map(g).reduce(function(t, e) {
            return t + j(He(i, "padding" + e)) + j(He(i, "border" + e + "Width"))
        }, 0) : 0
    }
    ...
    function di(t, e, i) {
        if (void 0 === e && (e = 0), void 0 === i && (i = 0), !Et(t)) return !1;
        var n = wi(t = W(t)),
    ...
    function fi(t, e) {
        ...
        var i = wi(t = W(t)),
            ...
            s = ri(i),
            a = s + Math.min(0, o - s),
            h = Math.max(0, s - (ri(n) + e - (o + r)));
        return Z((a + i.pageYOffset - o) / ((a + (r - (h < s ? h : 0))) / 100) / 100)
    }
    ...
    function gi(t, e, i) {
        return void 0 === e && (e = "width"), void 0 === i && (i = window), z(t) ? +t : u(t, "vh") ? vi(ri(wi(i)), t) : u(t, "vw") ? vi(oi(wi(i)), t) : u(t, "%") ? vi(ii(i)[e], t) : j(t)
    }
    ...
    var yi = {
        ...
        writes: [],
        read: function(t) {
            return this.reads.push(t), xi(), t
        },
        write: function(t) {
            return this.writes.push(t), xi(), t
        },
        clear: function(t) {
            return $i(this.reads, t) || $i(this.writes, t)
        },
        flush: function() {
            ki(this.reads), ki(this.writes.splice(0, this.writes.length)), this.scheduled = !1, (this.reads.length || this.writes.length) && xi()
        }
    };

    function xi() {
        yi.scheduled || (yi.scheduled = !0, requestAnimationFrame(yi.flush.bind(yi)))
    }
    ...
    Ii.prototype = {
        ...
        movesTo: function(t) {
            ...
            return e.right <= i.x || (e.left >= i.x ? (r[0].reverse(), r[1].reverse()) : e.bottom <= i.y ? r[0].reverse() : e.top >= i.y && r[1].reverse()), !!r.reduce(function(t, e) {
                return t + (Si(n, e[0]) < Si(i, e[0]) && Si(n, e[1]) > Si(i, e[1]))
            }, 0)
        }
    };
    var Ti = {};
    ...
    function Ei(t, e, i) {
        return Ti.computed(I(t) ? t.call(i, i) : t, I(e) ? e.call(i, i) : e)
    }
    ...
    function Ci(e, i, n) {
        var r = {};
        if (I(i) && (i = i.options), i.extends && (e = Ci(e, i.extends, n)), i.mixins)
            for (var t = 0, o = i.mixins.length; t < o; t++) e = Ci(e, i.mixins[t], n);
        for (var s in e) h(s);
        for (var a in i) c(e, a) || h(a);

        function h(t) {
            r[t] = (Ti[t] || function(t, e) {
                return H(e) ? t : e
            })(e[t], i[t], n)
        }
        return r
    ...
    function Ni(t, e) {
        ...
        void 0 === e && (e = []);
        try {
            return t ? w(t, "{") ? JSON.parse(t) : e.length && !y(t, ":") ? ((i = {})[e[0]] = t, i) : t.split(";").reduce(function(t, e) {
                var i = e.split(/:(.*)/),
                    n = i[0],
                    r = i[1];
    ...
    Ti.events = Ti.created = Ti.beforeConnect = Ti.connected = Ti.beforeDisconnect = Ti.disconnected = Ti.destroy = Ai, Ti.args = function(t, e) {
        return Ai(e || t)
    }, Ti.update = function(t, e) {
        return G(Ai(t, I(e) ? {
            read: e
        } : e), "order")
    }, Ti.props = function(t, e) {
        return $(e) && (e = e.reduce(function(t, e) {
            return t[e] = String, t
        }, {})), Ti.methods(t, e)
    }, Ti.computed = Ti.methods = function(t, e) {
        return e ? t ? X({}, t, e) : e : t
    }, Ti.data = function(e, i, t) {
        return t ? Ei(e, i, t) : i ? e ? function(t) {
            return Ei(e, i, t)
        } : i : e
    };
    var _i = 0,
        Mi = function(t) {
            this.id = ++_i, this.el = W(t)
        };
    ...
    Mi.prototype.isVideo = function() {
        ...
        var i, n = this.isYoutube(),
            r = this.isVimeo();
        return n || r ? this.ready = new Vt(function(t) {
            Dt(e.el, "load", function() {
                ...
                function(n) {
                    ...
                    return n && t.id === e.id && "onReady" === t.event || r && Number(t.player_id) === e.id
                }).then(function() {
                    t(), i && clearInterval(i)
                }), nt(e.el, "src", e.el.src + (y(e.el.src, "?") ? "&" : "?") + (n ? "enablejsapi=1" : "api=1&player_id=" + e.id))
        }) : Vt.resolve()
    ...
    var Di = "IntersectionObserver" in window ? window.IntersectionObserver : function() {
        function t(e, t) {
            var i = this;
            void 0 === t && (t = {});
            var n = t.rootMargin;
    ...
    function Bi(t) {
        return !(!w(t, "uk-") && !w(t, "data-uk-")) && m(t.replace("data-uk-", "").replace("uk-", ""))
    }
    var zi, Pi, Hi, Li, Fi = function(t) {
        this._init(t)
    };
    Fi.util = Object.freeze({
        ...
        function(i) {
            ...
            i.use = function(t) {
                ...
                (e = (D(e) ? i.component(e) : e) || this).options = Ci(e.options, t)
            }, i.extend = function(t) {
                t = t || {};
                var e = function(t) {
                    this._init(t)
                };
                return ((e.prototype = Object.create(this.prototype)).constructor = e).options = Ci(this.options, t), e.super = this, e.extend = this.extend, e
        ...
        }(Fi), (zi = Fi).prototype._callHook = function(t) {
            var e = this,
                i = this.$options[t];
            i && i.forEach(function(t) {
                return t.call(e)
            })
        }, zi.prototype._callConnected = function() {
        ...
        }, zi.prototype._callDisconnected = function() {
            this._connected && (this._callHook("beforeDisconnect"), this._observer && (this._observer.disconnect(), this._observer = null), this._unbindEvents(), this._callHook("disconnected"), this._connected = !1)
        }, zi.prototype._callUpdate = function(t) {
            var o = this;
            void 0 === t && (t = "update");
            var s = t.type || t;
            ...
            e && e.forEach(function(t, e) {
                var i = t.read,
                    n = t.write,
                    r = t.events;
                ("update" === s || y(r, s)) && (i && !y(yi.reads, a[e]) && (a[e] = yi.read(function() {
                    var t = o._connected && i.call(o, o._data, s);
                    !1 === t && n ? yi.clear(h[e]) : T(t) && X(o._data, t)
                })), n && !y(yi.writes, h[e]) && (h[e] = yi.write(function() {
        ...
        function(t) {
            ...
            function s(t, e) {
                ...
                for (var s in r) {
                    var a = p(s),
                        h = st(o, a);
                    if (!H(h)) {
                        if (h = r[s] === Boolean && "" === h || d(r[s], h), "target" === a && (!h || w(h, "_"))) continue;
                        i[s] = h
                    }
                }
                var c = Ni(st(o, e), n);
                ...
                Object.defineProperty(n, r, {
                    ...
                    get: function() {
                        var t = n._computeds,
                            e = n.$props,
                            i = n.$el;
                        return c(t, r) || (t[r] = (o.get || o).call(n, e, i)), t[r]
                    },
                    set: function(t) {
                        var e = n._computeds;
            ...
            t.prototype._init = function(t) {
                (t = t || {}).data = function(t, e) {
                    var i = t.data,
                        n = (t.el, e.args),
                        r = e.props;
                    if (void 0 === r && (r = {}), i = $(i) ? P(n) ? void 0 : i.slice(0, n.length).reduce(function(t, e, i) {
                            return T(e) ? X(t, e) : t[n[i]] = e, t
                        }, {}) : i)
                        for (var o in i) H(i[o]) ? delete i[o] : i[o] = r[o] ? d(r[o], i[o]) : i[o];
                    return i
                }(t, this.constructor.options), this.$options = Ci(this.constructor.options, t, this), this.$el = null, this.$props = {}, this._frames = {
                    reads: {},
                    writes: {}
                ...
                for (var i in e) {
                    var n = e[i];
                    delete e[i], t[i].watch && !q(n, this[i]) && t[i].watch.call(this, this[i], n)
                }
            }, t.prototype._initProps = function(t) {
                var e;
                for (e in t = t || s(this.$options, this.$name)) H(t[e]) || (this.$props[e] = t[e]);
                ...
                t && t.forEach(function(t) {
                    if (c(t, "handler")) l(i, t);
                    else
                        for (var e in t) l(i, t[e], e)
                })
                ...
                if (!this._observer && e && !1 !== n) {
                    n = $(n) ? n : Object.keys(e), this._observer = new MutationObserver(function() {
        ...
        }(Fi), Hi = (Pi = Fi).data, Li = {}, Pi.component = function(s, t) {
            if (!t) return T(Li[s]) && (Li[s] = Pi.extend(Li[s])), Li[s];
            Pi[s] = function(t, i) {
                for (var e = arguments.length, n = Array(e); e--;) n[e] = arguments[e];
                var r = Pi.component(s);
                return T(t) ? new r({
                    data: t
            ...
            if (e.name = s, e.install && e.install(Pi, e, s), Pi._initialized && !e.functional) {
                var i = p(s);
                yi.read(function() {
                    return Pi[s]("[uk-" + i + "],[data-uk-" + i + "]")
                })
            }
            return Li[s] = T(t) ? e : t
        }, Pi.getComponents = function(t) {
            return t && t[Hi] || {}
        }, Pi.getComponent = function(t, e) {
            return Pi.getComponents(t)[e]
        }, Pi.connect = function(t) {
            if (t[Hi])
        ...
        function(n) {
            ...
            n.prototype.$mount = function(t) {
                ...
                var e = this.$options,
                    i = e.el,
                    n = e.name;
                i && this._callDisconnected(), this._callHook("destroy"), i && i[r] && (delete i[r][n], P(i[r]) || delete i[r], t && ve(this.$el))
            ...
            methods: {
                toggleElement: function(c, u, l) {
                    ...
                    return new Vt(function(t) {
                        c = V(c);
                        var e, i = function(t) {
                                return Vt.all(t.map(function(t) {
                ...
                toggleNow: function(e, i) {
                    var n = this;
                    return new Vt(function(t) {
                        return Vt.all(V(e).map(function(t) {
                ...
                _toggleElement: function(t, e, i) {
                    var n = this;
                    if (e = O(e) ? e : Ze.inProgress(t) ? Me(t, "uk-animation-leave") : Ue.inProgress(t) ? "0px" === t.style.height : !this.isToggled(t), !Bt(t, "before" + (e ? "show" : "hide"), [this])) return Vt.reject();
                    var r = (I(i) ? i : !1 !== i && this.hasAnimation ? this.hasTransition ? function(t) {
                        var s = t.isToggled,
                            a = t.duration,
                            h = t.initProps,
                            c = t.hideProps,
                            ...
                            l = t._toggle;
                        return function(t, e) {
                            var i = Ue.inProgress(t),
                                n = t.hasChildNodes ? j(He(t.firstElementChild, "marginTop")) + j(He(t.lastElementChild, "marginBottom")) : 0,
                                r = Et(t) ? ri(t) + (i ? 0 : n) : 0;
                            Ue.cancel(t), s(t) || l(t, !0), ri(t, ""), yi.flush();
                            var o = ri(t) + (i ? 0 : n);
                            return ri(t, r), (e ? Ue.start(t, X({}, h, {
                                overflow: "hidden",
                                height: o
                        ...
                        var i = t.animation,
                            ...
                            o = t._toggle;
                        return function(t, e) {
                            return Ze.cancel(t), e ? (o(t, !0), Ze.in(t, i[0], n, r)) : Ze.out(t, i[1] || i[0], n, r).then(function() {
                                return o(t, !1)
                            })
                        }
                    ...
                    var o = function() {
                        Bt(t, e ? "shown" : "hidden", [n]), n.$update(t)
                    };
                    return r ? r.then(o) : Vt.resolve(o())
                },
                _toggle: function(t, e) {
                    var i;
                    t && (e = Boolean(e), this.cls ? (i = y(this.cls, " ") || e !== Me(t, this.cls)) && Oe(t, this.cls, y(this.cls, " ") ? void 0 : e) : (i = e === rt(t, "hidden")) && nt(t, "hidden", e ? null : ""), Te("[autofocus]", t).some(function(t) {
                ...
                toggle: function(r, o) {
                    ...
                    (r = this.items[t]) && [r].concat(!this.multiple && !y(a, r) && a || []).forEach(function(t) {
                        ...
                        if (i || !e || s.collapsible || !(a.length < 2)) {
                            Oe(t, s.clsOpen, i);
                            var n = t._wrapper ? t._wrapper.firstElementChild : Se(s.content, t);
                            t._wrapper || (t._wrapper = we(n, "<div>"), nt(t._wrapper, "hidden", i ? "" : null)), s._toggle(n, !0), s.toggleElement(t._wrapper, i, o).then(function() {
                                Me(t, s.clsOpen) === i && (i || s._toggle(n, !1), t._wrapper = null, ye(n))
                            })
                        }
                    })
                }
    ...
    function Ri(r) {
        ...
        he(function() {
            ...
            Mt(document, "animationstart", function(t) {
                var e = t.target;
                (He(e, "animationName") || "").match(/^uk-.*(left|right)/) && (n++, He(document.body, "overflowX", "hidden"), setTimeout(function() {
                    --n || He(document.body, "overflowX", "")
                }, R(He(e, "animationDuration")) + 100))
            }, !0)
        }), Mt(document, ie, function(t) {
            if (e && e(), jt(t)) {
                var r = Wt(t),
                ...
                e = Dt(document, re, function(t) {
                    var e = Wt(t),
                        i = e.x,
                        n = e.y;
                    (o && i && 100 < Math.abs(r.x - i) || n && 100 < Math.abs(r.y - n)) && setTimeout(function() {
                        Bt(o, "swipe"), Bt(o, "swipe" + function(t, e, i, n) {
                            return Math.abs(t - i) >= Math.abs(e - n) ? 0 < t - i ? "Left" : "Right" : 0 < e - n ? "Up" : "Down"
                        }(r.x, r.y, i, n))
                    })
                })
            }
    ...
    var qi, Ui, Xi = {
            ...
            connected: function() {
                this.inView && !rt(this.$el, "preload") && (this.$el.preload = "none"), this.player = new Mi(this.$el), this.automute && this.player.mute()
            },
            update: {
                read: function() {
                    return !!this.player && {
        ...
        Gi = {
            ...
            methods: {
                positionAt: function(t, e, i) {
                    ...
                    var r = this.offset,
                        o = this.getAxis();
                    z(r) || (r = (n = Se(r)) ? ei(n)["x" === o ? "left" : "top"] - ei(e)["x" === o ? "right" : "bottom"] : 0);
                    var s = ti(t, e, "x" === o ? li(this.dir) + " " + this.align : this.align + " " + li(this.dir), "x" === o ? this.dir + " " + this.align : this.align + " " + this.dir, "x" === o ? "" + ("left" === this.dir ? -r : r) : " " + ("top" === this.dir ? -r : r), null, this.flip, i).target,
                        a = s.x,
                        h = s.y;
        ...
        Ji = {
            ...
            events: [{
                ...
                handler: function(t) {
                    jt(t) || (qi && qi !== this && qi.toggle && y(qi.toggle.mode, "hover") && !_t(t.target, qi.toggle.$el) && !et({
                        x: t.pageX,
                        y: t.pageY
                    }, ei(qi.$el)) && qi.hide(!1), t.preventDefault(), this.show(this.toggle))
                }
            }, {
                name: "toggleshow",
                handler: function(t, e) {
                ...
                handler: function() {
                    this.tracker.init(), Bt(this.$el, "updatearia"),
                        function() {
                            if (Ui) return;
                            Ui = !0, Mt(document, re, function(t) {
                                var e, i = t.target,
                                    n = t.defaultPrevented;
                                if (!n)
                                    for (; qi && qi !== e && !_t(i, qi.$el) && (!qi.toggle || !_t(i, qi.toggle.$el));)(e = qi).hide(!1)
                            })
                        }()
                }
            }, {
                ...
                handler: function(t) {
                    var e = t.target;
                    this.$el === e ? (qi = this.isActive() ? null : qi, Bt(this.$el, "updatearia"), this.tracker.cancel()) : qi = null === qi && _t(e, this.$el) && this.isToggled() ? this : qi
                }
            }, {
                name: "updatearia",
                self: !0,
                handler: function(t, e) {
                    t.preventDefault(), this.updateAria(this.$el), (e || this.toggle) && (nt((e || this.toggle).$el, "aria-expanded", this.isToggled() ? "true" : "false"), Oe(this.toggle.$el, this.cls, this.isToggled()))
                }
            }],
            update: {
                write: function() {
                    ...
                    var r = function() {
                        ...
                        t = function() {
                            if (n.toggle = e || n.toggle, n.clearTimers(), !n.isActive())
                                if (i && qi && qi !== n && qi.isDelaying) n.showTimer = setTimeout(n.show, 10);
                                else {
                                    if (n.isParentOf(qi)) {
                                        if (!qi.hideTimer) return;
                                        qi.hide(!1)
                                    } else if (qi && n.isChildOf(qi)) qi.clearTimers();
                                    else if (qi && !n.isChildOf(qi) && !n.isParentOf(qi))
                                        for (var t; qi && qi !== t && !n.isChildOf(qi);)(t = qi).hide(!1);
                                    i && n.delayShow ? n.showTimer = setTimeout(r, n.delayShow) : r(), qi = n
                                }
                        };
    ...
    var Zi = {
        ...
        Qi = {
            ...
            computed: {
                ...
                target: function(t, e) {
                    var i = t.target;
                    return i && (!0 === i && this.input.parentNode === e && this.input.nextElementSibling || at(i, e))
                }
            },
            update: function() {
                var t = this.target,
                ...
                if (t) {
                    var i, n = Ct(t) ? "value" : "textContent",
                        r = t[n],
                        o = e.files && e.files[0] ? e.files[0].name : bt(e, "select") && (i = Te("option", e).filter(function(t) {
                            return t.selected
        ...
        en = {
            ...
            update: {
                read: function(t) {
                    ...
                    t.rows = nn(e), t.stacks = !t.rows.some(function(t) {
                        return 1 < t.length
                    })
                },
                write: function(t) {
                    ...
                    t.rows.forEach(function(t, i) {
                        return t.forEach(function(t, e) {
                            Oe(t, n.margin, 0 !== i), Oe(t, n.firstColumn, 0 === e)
                        })
                    })
                },
                events: ["resize"]
        ...
        for (var e = [
            ...
            if (r.height)
                for (var o = e.length - 1; 0 <= o; o--) {
                    ...
                    var a = void 0;
                    if (a = s[0].offsetParent === n.offsetParent ? rn(s[0]) : (r = rn(n, !0), rn(s[0], !0)), r.top >= a.bottom - 1) {
                        e.push([n]);
                        break
                    }
                    if (r.bottom > a.top) {
        ...
        update: [{
            read: function(t) {
                ...
                if (this.masonry && this.length) {
                    var o = 0;
                    i = r.reduce(function(i, t, n) {
                        return i[n] = t.map(function(t, e) {
                            return 0 === n ? 0 : j(i[n - 1][e]) + (o - j(r[n - 1][e] && r[n - 1][e].offsetHeight))
                        }), o = t.reduce(function(t, e) {
                            return Math.max(t, e.offsetHeight)
                        }, 0), i
                    }, []), n = function(t) {
                        return Math.max.apply(Math, t.reduce(function(i, t) {
                            return t.forEach(function(t, e) {
                        ...
                        return j(n ? He(n, "marginTop") : He(i[0], "paddingLeft"))
            ...
            write: function(t) {
                var e = t.stacks,
                    i = t.height;
                Oe(this.$el, this.clsStack, e), He(this.$el, "paddingBottom", this.parallax), !1 !== i && He(this.$el, "height", i)
            },
            events: ["resize"]
        }, {
            read: function(t) {
                var e = t.height;
                return {
                    scrolled: !!this.parallax && fi(this.$el, e ? e - ri(this.$el) : 0) * this.parallax
                }
            },
            write: function(t) {
                var e = t.rows,
                ...
                (!1 !== n || r) && e.forEach(function(t, i) {
                    return t.forEach(function(t, e) {
                        return He(t, "transform", n || r ? "translateY(" + ((r && -r[i][e]) + (n ? e % 2 ? n : n / 8 : 0)) + "px)" : "")
                    })
                })
            },
            events: ["scroll", "resize"]
    ...
    var sn = Jt ? {
            ...
            update: [{
                ...
                write: function() {
                    ...
                    this.elements.forEach(function(t) {
                        ...
                        e && (i.forceHeight || Math.round(e + ai("height", t, "content-box")) >= t.offsetHeight) && He(t, "height", e)
                    })
                },
                order: 5,
                events: ["resize"]
        ...
        an = {
            ...
            update: {
                read: function() {
                    return {
                        rows: (this.row ? nn(this.elements) : [this.elements]).map(hn)
                    }
                },
                write: function(t) {
    ...
    function hn(t) {
        ...
        return o && s && (He(t, "minHeight", ""), e = cn(t), n = e.heights, r = e.max), {
    ...
    var un = {
        ...
        update: {
            read: function() {
                ...
                if (this.expand) t = ri(window) - (ln(document.documentElement) - ln(this.$el)) - e || "";
                else {
                    if (t = "calc(100vh", this.offsetTop) {
                        var i = ei(this.$el).top;
                        t += i < ri(window) / 2 ? " - " + i + "px" : ""
                    }!0 === this.offsetBottom ? t += " - " + ln(this.$el.nextElementSibling) + "px" : z(this.offsetBottom) ? t += " - " + this.offsetBottom + "vh" : this.offsetBottom && u(this.offsetBottom, "px") ? t += " - " + j(this.offsetBottom) + "px" : D(this.offsetBottom) && (t += " - " + ln(at(this.offsetBottom, this.$el)) + "px"), t += (e ? " - " + e + "px" : "") + ")"
                }
                return {
                    minHeight: t
                }
    ...
    var dn = {
                    ...
                    return e.applyAttributes(t), e.svgEl = function(t, e) {
                        {
                            if (Tt(e) || "CANVAS" === e.tagName) {
                                ...
                                return vn(t, i) ? i : me(e, t)
                            }
                            var n = e.lastElementChild;
                            return vn(t, n) ? n : fe(e, t)
                        }
                    }(t, e.$el)
                }, Q)
            },
            disconnected: function() {
                var e = this;
                Tt(this.$el) && nt(this.$el, "hidden", null), this.svg && this.svg.then(function(t) {
            ...
            methods: {
                getSvg: function() {
                    ...
                    return function(i) {
                        if (fn[i]) return fn[i];
                        return fn[i] = new Vt(function(e, t) {
                            i ? w(i, "data:") ? e(decodeURIComponent(i.split(",")[1])) : Kt(i).then(function(t) {
                                return e(t.response)
                            }, function() {
                        ...
                        }(t, e.icon) || Vt.reject("SVG not found.")
                    })
                },
                applyAttributes: function(i) {
                    var n = this;
                    for (var t in this.$options.props) this[t] && y(this.include, t) && nt(i, t, this[t]);
                    ...
                    c && !h.some(function(t) {
                        ...
                        (t = (0 | t) * n.ratio) && nt(i, a[e], t), t && !h[1 ^ e] && ot(i, a[1 ^ e])
                    }), nt(i, "data-svg", this.icon || this.src)
                }
            }
        },
        fn = {};
        ...
        yn = {
            ...
            methods: {
                getSvg: function() {
                    var t = function(t) {
                        if (!bn[t]) return null;
                        wn[t] || (wn[t] = Se(bn[t].trim()));
                        return wn[t].cloneNode(!0)
                    }(function(t) {
                        return Zt ? U(U(t, "left", "right"), "previous", "next") : t
                    }(this.icon));
                    return t ? Vt.resolve(t) : Vt.reject("Icon not found.")
                }
            }
        },
        xn = {
            ...
            data: function(t) {
                return {
                    icon: p(t.constructor.options.name)
                }
            }
        },
        kn = {
            ...
            computed: {
                icon: function(t, e) {
                    var i = t.icon;
                    return Me(e, "uk-slidenav-large") ? i + "-large" : i
                }
            }
        },
        $n = {
            ...
            computed: {
                icon: function(t, e) {
                    var i = t.icon;
                    return Me(e, "uk-search-icon") && kt(e, ".uk-search-large").length ? "search-large" : kt(e, ".uk-search-navbar").length ? "search-navbar" : i
                }
            }
        },
        In = {
    ...
    var Tn = {
        ...
        connected: function() {
            Bn[this.cacheKey] ? En(this.$el, Bn[this.cacheKey] || this.dataSrc, this.dataSrcset, this.sizes) : this.isImg && this.width && this.height && En(this.$el, function(t, e, i) {
                var n;
                i && (n = it.ratio({
                    width: t,
                    height: e
                }, "width", gi(Cn(i))), t = n.width, e = n.height);
                return 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="' + t + '" height="' + e + '"></svg>'
            }(this.width, this.height, this.sizes)), this.observer = new Di(this.load, {
        ...
        update: {
            read: function(t) {
                ...
                i && i.then(function(t) {
                    return t && "" !== t.currentSrc && En(e.$el, Dn(t))
                })
            },
            write: function(t) {
                if (this.dataSrcset && 1 !== window.devicePixelRatio) {
                    ...
                    (e.match(/^(auto\s?)+$/) || j(e) === t.bgSize) && (t.bgSize = function(t, e) {
                        var i = gi(Cn(e)),
                            n = (t.match(Mn) || []).map(j).sort(function(t, e) {
                                return t - e
                            });
        ...
        methods: {
            load: function(t) {
                ...
                t.some(function(t) {
                    ...
                    return En(e.$el, Dn(t), t.srcset, t.sizes), Bn[e.cacheKey] = Dn(t), t
    ...
    function En(t, e, i, n) {
        if (On(t)) n && (t.sizes = n), i && (t.srcset = i), e && (t.src = e);
        else if (e) {
            !y(t.style.backgroundImage, e) && (He(t, "backgroundImage", "url(" + It(e) + ")"), Bt(t, zt("load", !1)))
        }
    }
    var An = /\s*(.*?)\s*(\w+|calc\(.*?\))\s*(?:,|$)/g;

    function Cn(t) {
        var e, i;
        for (An.lastIndex = 0; e = An.exec(t);)
            if (!e[1] || window.matchMedia(e[1]).matches) {
                e = w(i = e[2], "calc") ? i.substring(5, i.length - 1).replace(Nn, function(t) {
                    return gi(t)
    ...
    var Hn, Ln, Fn = {
        ...
        Wn = {
            ...
            events: [{
                ...
                handler: function(t) {
                    var i = Hn && Hn !== this && Hn;
                    Hn = this, i ? this.stack ? this.prev = i : ((Hn = i).isToggled() ? i.hide().then(this.show) : Dt(i.$el, "beforeshow hidden", this.show, !1, function(t) {
                        var e = t.target;
                        return "hidden" === t.type && e === i.$el
                    }), t.preventDefault()) : function() {
                        if (Ln) return;
                        Ln = [Mt(document, re, function(t) {
                            var e = t.target,
                                i = t.defaultPrevented;
                            !Hn || !Hn.bgClose || i || Hn.overlay && !_t(e, Hn.$el) || _t(e, Hn.panel) || Hn.hide()
                ...
                self: !0,
                handler: function() {
                    Me(document.documentElement, this.clsPage) || (this.scrollbarWidth = oi(window) - oi(document), He(document.body, "overflowY", this.scrollbarWidth && this.overlay ? "scroll" : "")), Ae(document.documentElement, this.clsPage)
                }
            }, {
                name: "hide",
                self: !0,
                handler: function() {
                    Hn && (Hn !== this || this.prev) || (Ln && Ln.forEach(function(t) {
                        return t()
                    }), Ln = null)
                }
            }, {
            ...
            methods: {
                ...
                show: function() {
                    var e = this;
                    return this.isToggled() ? Vt.resolve() : this.container && this.$el.parentNode !== this.container ? (fe(this.container, this.$el), new Vt(function(t) {
                ...
                hide: function() {
                    return this.isToggled() ? this.toggleElement(this.$el, !1, Vn(this)) : Vt.resolve()
                },
                getActive: function() {
                    return Hn
                }
    ...
    function Vn(t) {
        ...
        return function(i, n) {
            return new Vt(function(t, e) {
                return Dt(i, "show hide", function() {
                    i._reject && i._reject(), i._reject = e, o(i, n), R(He(r, "transitionDuration")) ? Dt(r, "transitionend", t, !1, function(t) {
                        return t.target === r
                    }) : t()
                })
            })
    ...
    var Yn = {
        install: function(a) {
            a.modal.dialog = function(t, e) {
                ...
                return i = X({
                    ...
                    return Mt(a.modal.dialog(' <div class="uk-modal-body">' + (D(e) ? e : de(e)) + '</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-primary uk-modal-close" autofocus>' + i.labels.ok + "</button> </div> ", i).$el, "hide", t)
                })
                ...
                return o = X({
                    ...
                    escClose: !0,
                    labels: a.modal.labels
                }, o), new Vt(function(e, t) {
                    var i = a.modal.dialog(' <form> <div class="uk-modal-body">' + (D(r) ? r : de(r)) + '</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-default uk-modal-close" type="button">' + o.labels.cancel + '</button> <button class="uk-button uk-button-primary" autofocus>' + o.labels.ok + "</button> </div> </form> ", o),
                        n = !1;
        ...
        events: [{
            ...
            self: !0,
            handler: function() {
                Me(this.panel, "uk-margin-auto-vertical") ? Ae(this.$el, "uk-flex") : He(this.$el, "display", "block"), ri(this.$el)
            }
        }, {
            name: "hidden",
            self: !0,
        ...
        qn = {
            ...
            events: [{
                ...
                handler: function() {
                    ...
                    t && !bt(this.dropbar, ":hover") && t.hide()
                }
            }, {
                name: "beforeshow",
                capture: !0,
                ...
                handler: function(t, e) {
                    var i = e.$el,
                        n = e.dir;
                    this.clsDrop && Ae(i, this.clsDrop + "-dropbar"), "bottom" === n && this.transitionTo(i.offsetHeight + j(He(i, "marginTop")) + j(He(i, "marginBottom")), i)
                }
            }, {
                name: "beforehide",
                filter: function() {
                ...
                handler: function(t, e) {
                    var i = e.$el,
                        n = this.getActive();
                    bt(this.dropbar, ":hover") && n && n.$el === i && t.preventDefault()
                }
            }, {
                name: "hide",
                filter: function() {
            ...
            methods: {
                ...
                transitionTo: function(t, e) {
                    var i = this,
                        n = this.dropbar,
                        r = Et(n) ? ri(n) : 0;
                    return He(e = r < t && e, "clip", "rect(0," + e.offsetWidth + "px," + r + "px,0)"), ri(n, r), Ue.cancel([e, n]), Vt.all([Ue.start(n, {
                        height: t
            ...
            update: {
                read: function() {
                    return !(!this.content || !this.container) && {
                        ...
                        max: Math.max(150, ri(this.container) - (ei(this.content).height - ri(this.$el)))
                    }
                },
                write: function(t) {
                    var e = t.current,
                        i = t.max;
                    He(this.$el, "maxHeight", i), Math.round(e) !== Math.round(i) && Bt(this.$el, "resize")
                },
                events: ["resize"]
            }
        },
            ...
            update: {
                read: function() {
                    return !!(Et(this.$el) && this.width && this.height) && {
                        width: oi(this.$el.parentNode),
                        height: this.height
                    }
                },
                write: function(t) {
                    ri(this.$el, it.contain({
                        height: this.height,
                        width: this.width
                    }, t).height)
                },
        ...
        Jn = {
            ...
            methods: {
                scrollTo: function(e) {
                    ...
                    var t = ri(document),
                        n = ri(window),
                        r = ei(e).top - this.offset;
                    if (t < r + n && (r = t - n), Bt(this.$el, "beforescroll", [this, e])) {
                        var o = Date.now(),
                            s = window.pageYOffset,
                            a = function() {
                                var t = s + (r - s) * function(t) {
                                    return .5 * (1 - Math.cos(Math.PI * t))
                                }(Z((Date.now() - o) / i.duration));
                                pi(window, t), t !== r ? requestAnimationFrame(a) : Bt(i.$el, "scrolled", [i, e])
                            };
                        a()
                    }
                }
    ...
    var Zn = {
            ...
            update: [{
                ...
                read: function(t) {
                    ...
                    t.update && this.elements.forEach(function(t) {
                        ...
                        e || (e = {
                            cls: st(t, "uk-scrollspy-class") || i.cls
                        }), e.show = di(t, i.offsetTop, i.offsetLeft), t._ukScrollspyState = e
                    })
                },
                write: function(r) {
                    var o = this;
                    ...
                    this.elements.forEach(function(t) {
                        ...
                        if (!i.show || i.inview || i.queued) {
                            if (!i.show && (i.inview || i.queued) && o.repeat) {
                                if (i.abort && i.abort(), !i.inview) return;
                                He(t, "visibility", o.hidden ? "hidden" : ""), Ce(t, o.inViewClass), Oe(t, e), Bt(t, "outview"), o.$update(t), i.inview = !1
                            }
                        } else {
                            var n = function() {
                                He(t, "visibility", ""), Ae(t, o.inViewClass), Oe(t, e), Bt(t, "inview"), o.$update(t), i.inview = !0, i.abort && i.abort()
                            };
                            o.delay ? (i.queued = !0, r.promise = (r.promise || Vt.resolve()).then(function() {
                                return !i.inview && new Vt(function(t) {
        ...
        tr = {
                    ...
                    if (!1 !== this.targetOffset && location.hash && 0 < window.pageYOffset) {
                        ...
                        r && yi.read(function() {
                            var t = ei(r).top,
                                e = ei(n.$el).top,
                                i = n.$el.offsetHeight;
                            n.isFixed && t <= e + i && e <= t + r.offsetHeight && pi(window, t - i - (z(n.targetOffset) ? n.targetOffset : 0) - n.offset)
                        })
                    }
                }
            }],
            update: [{
                read: function(t, e) {
                    var i = t.height;
                    this.isActive && "update" !== e && (this.hide(), i = this.$el.offsetHeight, this.show()), i = this.isActive ? i : this.$el.offsetHeight, this.topOffset = ei(this.isFixed ? this.placeholder : this.$el).top, this.bottomOffset = this.topOffset + i;
                    var n = er("bottom", this);
                    return this.top = Math.max(j(er("top", this)), this.topOffset) - this.offset, this.bottom = n && n - i, this.inactive = !this.matchMedia, {
                        lastScroll: !1,
                        height: i,
                ...
                write: function(t) {
                    ...
                    He(n, X({
                        height: e
                    }, i)), _t(n, document) || (me(this.$el, n), nt(n, "hidden", "")), this.isActive = this.isActive
                },
                events: ["resize"]
            }, {
                read: function(t) {
                ...
                write: function(t, e) {
                    ...
                    var r = t.dir,
                        ...
                        c = t.visible,
                        u = performance.now();
                    if (!((t.lastScroll = a) < 0 || a === s || !c || this.disabled || this.showOnUp && "scroll" !== e || ((300 < u - n || r !== o) && (t.initScroll = a, t.initTimestamp = u), t.lastDir = r, this.showOnUp && Math.abs(t.initScroll - a) <= 30 && Math.abs(s - a) <= 10)))
    ...
    function er(t, e) {
        ...
        if (o) {
            if (z(o)) return r + j(o);
            if (D(o) && o.match(/^-?\d+vh$/)) return ri(window) * j(o) / 100;
            var s = !0 === o ? n.parentNode : at(o, n);
    ...
    var ir, nr = {
            ...
            methods: {
                ...
                show: function(t) {
                    for (var e, i, n = this, r = this.$el.children, o = r.length, s = this.index(), a = 0 <= s, h = "previous" === t ? -1 : 1, c = ue(t, r, s), u = 0; u < o; u++, c = (c + h + o) % o)
                        if (!bt(this.toggles[c], ".uk-disabled *, .uk-disabled, [disabled]")) {
                            e = this.toggles[c], i = r[c];
                            break
                        }!i || 0 <= s && Me(i, this.cls) || s === c || (Ce(r, this.cls), Ae(i, this.cls), nt(this.toggles, "aria-expanded", !1), nt(e, "aria-expanded", !0), this.connects.forEach(function(t) {
                        a ? n.toggleElement([t.children[s], t.children[c]]) : n.toggleNow(t.children[c])
                    }))
                }
            }
        },
    ...
    Fi.version = "3.1.4", (ir = Fi).component("accordion", Vi), ir.component("alert", Yi), ir.component("cover", Ki), ir.component("drop", Ji), ir.component("dropdown", Zi), ir.component("formCustom", Qi), ir.component("gif", tn), ir.component("grid", on), ir.component("heightMatch", an), ir.component("heightViewport", un), ir.component("icon", yn), ir.component("img", Tn), ir.component("leader", Fn), ir.component("margin", en), ir.component("modal", Yn), ir.component("nav", Rn), ir.component("navbar", qn), ir.component("offcanvas", Un), ir.component("overflowAuto", Kn), ir.component("responsive", Gn), ir.component("scroll", Jn), ir.component("scrollspy", Zn), ir.component("scrollspyNav", Qn), ir.component("sticky", tr), ir.component("svg", dn), ir.component("switcher", nr), ir.component("tab", rr), ir.component("toggle", or), ir.component("video", Xi), ir.component("close", In), ir.component("marker", xn), ir.component("navbarToggleIcon", xn), ir.component("overlayIcon", xn), ir.component("paginationNext", xn), ir.component("paginationPrevious", xn), ir.component("searchIcon", $n), ir.component("slidenavNext", kn), ir.component("slidenavPrevious", kn), ir.component("spinner", Sn), ir.component("totop", xn), ir.use(Ri);
    var sr = {
        mixins: [ji],
        props: {
            date: String,
        ...
        update: {
            write: function() {
                ...
                r.total <= 0 && (this.stop(), r.days = r.hours = r.minutes = r.seconds = 0), this.units.forEach(function(t) {
                    ...
                    e = e.length < 2 ? "0" + e : e;
                    var i = n[t];
                    i.textContent !== e && ((e = e.split("")).length !== i.children.length && de(i, e.map(function() {
                        return "<span></span>"
        ...
        cr = {
            ...
            methods: {
                animate: function(t) {
                    ...
                    ! function() {
                        if (ar) return;
                        (ar = fe(document.head, "<style>").sheet).insertRule("." + hr + " > * {\n            margin-top: 0 !important;\n            transform: none !important;\n        }", 0)
                    }();
                    ...
                    t(), Ue.cancel(this.target), r.forEach(Ue.cancel), lr(this.target), this.$update(this.target), yi.flush();
                    var s = ri(this.target),
                        a = (r = r.concat(V(this.target.children).filter(function(t) {
                            return !y(r, t)
                        }))).map(function(t, e) {
                            return !!(t.parentNode && e in o) && (o[e] ? Et(t) ? dr(t) : {
                                opacity: 0
                            } : {
                                opacity: Et(t) ? 1 : 0
                            })
                    ...
                    return o = a.map(function(t, e) {
                        ...
                        return i
                    }), Ae(this.target, hr), r.forEach(function(t, e) {
                        return o[e] && He(t, o[e])
                    }), He(this.target, "height", e), pi(window, i), Vt.all(r.map(function(t, e) {
                        return o[e] && a[e] ? Ue.start(t, a[e], n.animation, "ease") : Vt.resolve()
                        ...
                        }), lr(n.target), n.$update(n.target), yi.flush()
                    }, Q)
                }
            }
        };
    ...
    var fr = {
        ...
        connected: function() {
            ...
            if (this.updateState(), !1 !== this.selActive) {
                var i = Te(this.selActive, this.$el);
                this.toggles.forEach(function(t) {
                    return Oe(t, e.cls, y(i, t))
                })
            }
        },
        methods: {
            ...
            setState: function(o, t) {
                ...
                var a = this.children;
                this.toggles.forEach(function(t) {
                    return Oe(t, s.cls, !! function(t, e, i) {
                        var n = i.filter;
                        void 0 === n && (n = {
                            "": ""
                        });
                        ...
                        var u = a.sort,
                            l = a.order;
                        void 0 === l && (l = "asc");
                        return H(u) ? c in n && h === n[c] || !h && c && !(c in n) && !n[""] : o === u && s === l
                    }(t, s.attrItem, o))
                });
                var e = function() {
                    var e = function(t) {
                    ...
                    if (i) {
                        var r = function(t, i, n) {
                            return X([], t).sort(function(t, e) {
                                return st(t, i).localeCompare(st(e, i), void 0, {
                                    numeric: !0
                                }) * ("asc" === n || -1)
                            })
                        }(a, i, n);
    ...
    function mr(t, e, i) {
        var n = pr(t, e),
            ...
            s = n.sort,
            a = n.order;
        return void 0 === a && (a = "asc"), (r || H(s)) && (o ? r ? (delete i.filter[""], i.filter[o] = r) : (delete i.filter[o], (P(i.filter) || "" in i.filter) && (i.filter = {
            "": r || ""
        })) : i.filter = {
            "": r || ""
        }), H(s) || (i.sort = [s, a]), i
        ...
        mixins: [{
            ...
            methods: {
                start: function() {
                    ...
                    var e = "touchmove" != ne ? Mt(document, ne, this.move, {
                        passive: !1
                    }) : Q;
                ...
                move: function(t) {
                    ...
                    if (this.unbindMove) {
                        ...
                        if (!(0 == i || this.prevPos === this.pos || !this.dragging && Math.abs(i) < this.threshold)) {
                            He(this.list, "pointerEvents", "none"), t.cancelable && t.preventDefault(), this.dragging = !0, this.dir = i < 0 ? 1 : -1;
                            ...
                            [this.index, this.prevIndex].filter(function(t) {
                                ...
                                Bt(n[t], "itemhidden", [e]), d && (h = !0, e.prevIndex = r)
                            }), (this.index === r && this.prevIndex !== r || h) && Bt(n[this.index], "itemshown", [this]), l && (this.prevIndex = r, this.index = s, !d && Bt(c, "beforeitemhide", [this]), Bt(u, "beforeitemshow", [this])), this._transitioner = this._translate(Math.abs(this.percent), c, !d && u), l && (!d && Bt(c, "itemhide", [this]), Bt(u, "itemshow", [this]))
                        }
                    }
                },
                end: function() {
            ...
            methods: {
                updateNav: function() {
                    ...
                    this.navItems.forEach(function(t) {
                        var e = st(t, i.attrItem);
                        Oe(t, i.clsActive, F(e) === n), Oe(t, "uk-invisible", i.finite && ("previous" === e && 0 === n || "next" === e && n >= i.maxIndex))
                    })
                }
            }
        }],
        ...
        methods: {
                    ...
                    if (n[e ? "unshift" : "push"](t), !e && 1 < n.length) 2 === n.length && this._transitioner.forward(Math.min(this.duration, 200));
                        ...
                        if (a !== c) {
                            ...
                            var u = this._show(a, c, e).then(function() {
                                return a && Bt(a, "itemhidden", [i]), Bt(c, "itemshown", [i]), new Vt(function(t) {
                                    yi.write(function() {
            ...
            _show: function(t, e, i) {
                if (this._transitioner = this._getTransitioner(t, e, this.dir, X({
                    ...
                    }, this.transitionOptions)), !i && !t) return this._transitioner.translate(1), Vt.resolve();
            ...
            _getTransitioner: function(t, e, i, n) {
                return void 0 === t && (t = this.prevIndex), void 0 === e && (e = this.index), void 0 === i && (i = this.dir || 1), void 0 === n && (n = this.transitionOptions), new this.Transitioner(B(t) ? this.slides[t] : t, B(e) ? this.slides[e] : e, i * (Zt ? -1 : 1), n)
            }
        }
    };
    ...
    var Ir = {
                ...
                Transitioner: function(o, s, a, t) {
                    ...
                    return {
                        ...
                        show: function(t, e, i) {
                            ...
                            void 0 === e && (e = 0);
                            var r = i ? "linear" : h;
                            return t -= Math.round(t * Z(e, -1, 1)), this.translate(e), xr(s, "itemin", {
                                percent: e,
                                duration: t,
                                timing: r,
                                dir: a
                                ...
                                timing: r,
                                dir: a
                            }), Vt.all([Ue.start(s, c[1], t, r), Ue.start(o, c[0], t, r)]).then(function() {
                                n.reset(), u.resolve()
                            }, Q), u.promise
                        },
                        stop: function() {
                        ...
                        translate: function(t) {
                            this.reset();
                            var e = n(t, a);
                            He(s, e[1]), He(o, e[0]), xr(s, "itemtranslatein", {
                                percent: t,
                                dir: a
        ...
        Sr = {
            ...
            events: [{
                ...
                name: "beforeitemshow",
                handler: function(t) {
                    this.isToggled() || (this.draggable = !1, t.preventDefault(), this.toggleNow(this.$el, !0), this.animation = yr.scale, Ce(t.target, this.clsActive), this.stack.splice(1, 0, this.index))
                }
            }, {
                name: "itemshow",
                handler: function(t) {
                    ...
                    He(this.caption, "display", i ? "" : "none"), de(this.caption, i);
                ...
                handler: function(t, r) {
                    ...
                    if (this.setItem(r, "<span uk-spinner></span>"), e)
                        if ("image" === i || e.match(/\.(jp(e)?g|png|gif|svg|webp)($|\?)/i)) Gt(e).then(function(t) {
                        ...
                        nt(a, "src", e), Dt(a, "error loadedmetadata", function(t) {
            ...
            methods: {
                ...
                setItem: function(t, e) {
                    ...
                    var i = de(this.slides[this.items.indexOf(t)], e);
                    Bt(this.$el, "itemloaded", [this, i]), this.$update(i)
                },
                setError: function(t) {
    ...
    var Er, Ar = {
        ...
        computed: {
            ...
            items: function() {
                return J(this.toggles.map(Cr), "source")
            }
        },
        disconnected: function() {
            this.hide()
    ...
    function Cr(i) {
        return ["href", "caption", "type", "poster", "alt"].reduce(function(t, e) {
            return t["href" === e ? "source" : e] = st(i, e), t
        }, {})
    }
    var Nr = {},
        _r = {
            ...
            created: function() {
                Nr[this.pos] || (Nr[this.pos] = fe(this.$container, '<div class="uk-notification uk-notification-' + this.pos + '"></div>'));
                var t = He(Nr[this.pos], "display", "block");
            ...
            methods: {
                close: function(t) {
                    var e = this,
                        i = function() {
                            Bt(e.$el, "close", [e]), ve(e.$el), Nr[e.pos].children.length || He(Nr[e.pos], "display", "none")
                        };
                    this.timer && clearTimeout(this.timer), t ? i() : Ue.start(this.$el, this.startProps).then(i)
                }
            }
        };
    var Mr = ["x", "y", "bgx", "bgy", "rotate", "scale", "color", "backgroundColor", "borderColor", "opacity", "blur", "hue", "grayscale", "invert", "saturate", "sepia", "fopacity", "stroke"],
        Or = {
            mixins: [Pn],
                    ...
                    return Mr.reduce(function(t, e) {
                        ...
                        if (o) {
                            ...
                            if (a = a.map(function(t) {
                                    return gi(t, u, v.$el)
                                }), He(g, "background-position-" + e[2], ""), n = He(g, "backgroundPosition").split(" ")["x" === e[2] ? 0 : 1], v.covers) {
                ...
                covers: function(t, e) {
                    return function(t) {
                        var e = t.style.backgroundSize,
                            i = "cover" === He(He(t, "backgroundSize", ""), "backgroundSize");
                ...
                getCss: function(l) {
                    ...
                    return Object.keys(d).reduce(function(t, e) {
                        ...
                        switch (e) {
                            case "x":
                            case "y":
                                r = r || "px", t.transform += " translate" + g(e) + "(" + j(s).toFixed("px" === r ? 0 : 2) + r + ")";
                                break;
                            case "rotate":
    ...
    function Pr(t, e, i) {
        ...
        return i ? n - function(t, e) {
            return jr(e).width / 2 - jr(t).width / 2
        }(t, e) : Math.min(n, Hr(e))
    }

    function Hr(t) {
        return Math.max(0, Lr(t) - jr(t).width)
    }
    ...
    function Fr(t, e) {
        return (ni(t).left + (Zt ? jr(t).width - jr(e).width : 0)) * (Zt ? -1 : 1)
    }
    ...
    var Yr = {
            ...
            data: {
                ...
                Transitioner: function(r, n, o, t) {
                    var e = t.center,
                        ...
                        c = n ? Pr(n, a, e) : i + jr(r).width * o * (Zt ? -1 : 1);
                    return {
                        dir: o,
                        show: function(t, e, i) {
                            void 0 === e && (e = 0);
                            var n = i ? "linear" : s;
                            return t -= Math.round(t * Z(e, -1, 1)), this.translate(e), r && this.updateTranslates(), e = r ? e : Z(e, 0, 1), Wr(this.getItemIn(), "itemin", {
                                percent: e,
                                duration: t,
                                timing: n,
                                dir: o
                                ...
                                transform: wr(-c * (Zt ? -1 : 1), "px")
                            }, t, n).then(h.resolve, Q), h.promise
                        },
                        stop: function() {
                            return Ue.stop(a)
                        },
                        ...
                        translate: function(t) {
                            ...
                            He(a, "transform", wr(Z(e - e * t - c, -Lr(a), jr(a).width) * (Zt ? -1 : 1), "px")), this.updateTranslates(), r && (t = Z(t, -1, 1), Wr(this.getItemIn(), "itemtranslatein", {
                                percent: t,
                                dir: o
                        ...
                        percent: function() {
                            return Math.abs((He(a, "transform").split(",")[4] * (Zt ? -1 : 1) + i) / (c - i))
                        },
                        getDistance: function() {
                            return Math.abs(c - i)
                        },
                        getItemIn: function(t) {
                            ...
                            var e = this.getActives(),
                                i = G(Vr(a), "offsetLeft"),
                                n = ce(i, e[0 < o * (t ? -1 : 1) ? e.length - 1 : 0]);
                            return ~n && i[n + (r && !t ? o : 0)]
                        },
                        getActives: function() {
                            var i = Pr(r || n, a, e);
                            return G(Vr(a).filter(function(t) {
                                var e = Fr(t, a);
            ...
            computed: {
                avgWidth: function() {
                    return Lr(this.list) / this.length
                },
                finite: function(t) {
                    return t.finite || Lr(this.list) < jr(this.list).width + function(t) {
                        return Vr(t).reduce(function(t, e) {
                ...
                sets: function(t) {
                    var o = this,
                        ...
                        h = s,
                        c = 0;
                    return !P(e = e && this.slides.reduce(function(t, e, i) {
                        var n = jr(e).width;
                        if (a < c + n && (!o.center && i > o.maxIndex && (i = o.maxIndex), !y(t, i))) {
                            var r = o.slides[i + 1];
                            o.center && r && n < h - jr(r).width / 2 ? h -= n : (h = s, t.push(i), a = c + s + (o.center ? n / 2 : 0))
                        }
                        return c += n, t
                    }, [])) && e
                },
            ...
            update: {
                write: function() {
                    ...
                    Te("[" + this.attrItem + "],[data-" + this.attrItem + "]", this.$el).forEach(function(t) {
                        var e = st(t, i.attrItem);
                        i.maxIndex && Oe(t, "uk-hidden", z(e) && (i.sets && !y(i.sets, j(e)) || e > i.maxIndex))
                    })
                },
                events: ["resize"]
            },
            ...
            events: [{
                ...
                handler: function(t) {
                    var e = t.type,
                        ...
                        o = i.timing,
                        s = i.dir;
                    Ue.cancel(this.$el), He(this.$el, this.getCss(Ur(e, s, n))), Ue.start(this.$el, this.getCss(qr(e) ? .5 : 0 < s ? 1 : 0), r, o).catch(Q)
                }
            }, {
                ...
                handler: function(t) {
                    var e = t.type,
                        ...
                        n = i.percent,
                        r = i.dir;
                    Ue.cancel(this.$el), He(this.$el, this.getCss(Ur(e, r, n)))
                }
            }]
        };
        ...
        Jr = {
            ...
            update: {
                write: function() {
                    if (this.clsEmpty && Oe(this.$el, this.clsEmpty, P(this.$el.children)), He(this.handle ? Te(this.handle, this.$el) : this.$el.children, {
                        ...
                        var t, e = ei(this.drag),
                            i = e.top,
                            n = i + e.height;
                        0 < i && i < this.scrollY ? t = this.scrollY - 5 : n < ri(document) && n > ri(window) + this.scrollY && (t = this.scrollY + 5), t && setTimeout(function() {
                            return pi(window, t)
                        }, 5)
                    }
                }
            ...
            methods: {
                init: function(t) {
                    ...
                    !r || n || 0 < i || Ct(e) || _t(e, "." + this.clsNoDrag) || this.handle && !_t(e, this.handle) || (t.preventDefault(), this.touched = [this], this.placeholder = r, this.origin = X({
                        target: e,
                        index: ce(r)
                    }, this.pos), Mt(document, ne, this.move), Mt(document, re, this.end), Mt(window, "scroll", this.scroll), this.threshold || this.start(t))
                },
                start: function(t) {
                    ...
                    }, He(this.placeholder, ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom"]))), nt(this.drag, "uk-no-boot", ""), Ae(this.drag, this.clsDrag, this.clsCustom), ri(this.drag.firstElementChild, ri(this.placeholder.firstElementChild));
                    ...
                    X(this.origin, {
                        left: i - this.pos.x,
                        top: n - this.pos.y
                    }), He(this.origin.target, "pointerEvents", "none"), Ae(this.placeholder, this.clsPlaceholder), Ae(this.$el.children, this.clsItem), Ae(document.documentElement, this.clsDragState), Bt(this.$el, "start", [this, this.placeholder]), this.move(t)
                },
                move: function(t) {
                    if (this.drag) {
                        this.$emit();
                        ...
                        if (i && !_t(e, this.placeholder) && (!r || i.group && i.group === n.group)) {
                            if (e = i.$el === e.parentNode && e || V(i.$el.children).filter(function(t) {
                                    return _t(e, t)
                                })[0], r) n.remove(this.placeholder);
                            else if (!e) return;
                            i.insert(this.placeholder, e), y(this.touched, i) || this.touched.push(i)
                        }
                    } else(Math.abs(this.pos.x - this.origin.x) > this.threshold || Math.abs(this.pos.y - this.origin.y) > this.threshold) && this.start(t)
                },
                end: function(t) {
                    if (Ot(document, ne, this.move), Ot(document, re, this.end), Ot(window, "scroll", this.scroll), He(this.origin.target, "pointerEvents", ""), this.drag) {
    ...
    var Zr = [],
        Qr = {
            ...
            beforeConnect: function() {
                this._hasTitle = rt(this.$el, "title"), nt(this.$el, {
                    title: "",
                    "aria-expanded": !1
                })
            },
            ...
            methods: {
                show: function() {
                    var e = this;
                    this.isActive() || (Zr.forEach(function(t) {
                        return t.hide()
                    }), Zr.push(this), this._unbind = Mt(document, re, function(t) {
                ...
                hide: function() {
                    !this.isActive() || bt(this.$el, "input") && this.$el === document.activeElement || (Zr.splice(Zr.indexOf(this), 1), clearTimeout(this.showTimer), clearInterval(this.hideTimer), nt(this.$el, "aria-expanded", !1), this.toggleElement(this.tooltip, !1), this.tooltip && ve(this.tooltip), this.tooltip = !1, this._unbind())
                },
                _show: function() {
                    this.tooltip = fe(this.container, '<div class="' + this.clsPos + '" aria-expanded="true" aria-hidden> <div class="' + this.clsPos + '-inner">' + this.title + "</div> </div>"), this.positionAt(this.tooltip, this.$el), this.origin = "y" === this.getAxis() ? li(this.dir) + "-" + this.align : this.align + "-" + li(this.dir), this.toggleElement(this.tooltip, !0)
                },
                isActive: function() {
                    return y(Zr, this)
                }
        ...
        to = {
            ...
            events: {
                ...
                dragover: function(t) {
                    io(t), Ae(this.$el, this.clsDragover)
                },
                dragleave: function(t) {
                    io(t), Ce(this.$el, this.clsDragover)
                }
            },
            methods: {
                upload: function(t) {
                            ...
                            o = function(t) {
                                ...
                                Kt(n.url, {
                                    ...
                                    beforeSend: function(t) {
                                        var e = t.xhr;
                                        e.upload && Mt(e.upload, "progress", n.progress), ["loadStart", "load", "loadEnd", "abort"].forEach(function(t) {
    ...
    return Fi.component("countdown", sr), Fi.component("filter", fr), Fi.component("lightbox", Ar), Fi.component("lightboxPanel", Sr), Fi.component("notification", _r), Fi.component("parallax", Br), Fi.component("slider", Yr), Fi.component("sliderParallax", Rr), Fi.component("slideshow", Gr), Fi.component("slideshowParallax", Rr), Fi.component("sortable", Jr), Fi.component("tooltip", Qr), Fi.component("upload", to),
        function(o) {
            ...
            function t() {
                h(document.body, s), yi.flush(), new MutationObserver(function(t) {
                    return t.forEach(e)
                }).observe(document, {
                    childList: !0,
                    subtree: !0,
